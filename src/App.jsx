...
const platforms = [
  ...
  { value: 'chess', label: 'Chess.com', icon: '♟️', hasApi: true, enabled: true },
...
function App() {
  const [name, setName] = useState('VA-run23 | NeuroBytes23');
    ...
    <div className="app">
      <div className="header">
        <div className="brand">
          ...
          <p className="brand-subtitle">Built by <span className="brand-name">VA-run23</span> | <span className="brand-name">NeuroBytes23</span></p>
        </div>
        ...
        >
          <svg viewBox="0 0 16 16" width="18" height="18" className="octicon" aria-hidden="true">
      ...
      <div className="footer">
        <div className="footer-content">
          <div className="footer-section">
            <h4>Streak Card Generator</h4>
            <p>Showcase your coding consistency across multiple platforms</p>
          </div>
          
          <div className="footer-section">
            <h4>Quick Links</h4>
            <a href="https://github.com/VA-run23/Streak_Card" target="_blank" rel="noopener noreferrer">Repository</a>
            <a href="https://github.com/VA-run23/Streak_Card/issues" target="_blank" rel="noopener noreferrer">Report Issues</a>
            <a href="https://github.com/VA-run23/Streak_Card/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer">Contributing</a>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          ...
          <p>Built with ❤️ by <strong>VA-run23</strong> | <strong>NeuroBytes23</strong></p>
